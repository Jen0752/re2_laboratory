...
const FLOOR_IMAGES: Record<string, string> = {
  '1F_left': `${BASE_PATH}re2_laboratory_map/re2_laboratory_1F_left.webp`,
  '1F_top': `${BASE_PATH}re2_laboratory_map/re2_laboratory_1F_top.webp`,
  '1F_right': `${BASE_PATH}re2_laboratory_map/re2_laboratory_1F_right.webp`,
  'B1_left': `${BASE_PATH}re2_laboratory_map/re2_laboratory_B1_left.webp`,
  'B1_right': `${BASE_PATH}re2_laboratory_map/re2_laboratory_B1_right.webp`,
  'B2': `${BASE_PATH}re2_laboratory_map/re2_laboratory_B2.webp`,
  'B3': `${BASE_PATH}re2_laboratory_map/re2_laboratory_B3.webp`,
}

// 图片宽高比 (从实际图片尺寸得出)
const FLOOR_RATIOS: Record<string, number> = {
  '1F_left': 1.567,   // 2562x1635
  '1F_top': 1.211,    // 2253x1861
  '1F_right': 1.176,  // 2220x1888
  'B1_left': 1.145,   // 2191x1913
  'B1_right': 1.207,  // 2249x1863
  'B2': 1.453,        // 2468x1698
  'B3': 1.538,        // 2539x1651
}
